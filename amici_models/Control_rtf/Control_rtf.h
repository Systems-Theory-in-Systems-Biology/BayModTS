...
extern std::array<const char*, 3> fixedParameterNames;
extern std::array<const char*, 0> stateNames;
...
extern std::array<const char*, 3> fixedParameterIds;
extern std::array<const char*, 0> stateIds;
extern std::array<const char*, 1> observableIds;
extern std::array<const char*, 2> expressionIds;
extern std::array<int, 0> stateIdxsSolver;
extern std::array<bool, 0> rootInitialValues;

extern void Jy_Control_rtf(realtype *Jy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my);
extern void dJydsigma_Control_rtf(realtype *dJydsigma, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my);
extern void dJydy_Control_rtf(realtype *dJydy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my);
extern void dJydy_colptrs_Control_rtf(SUNMatrixWrapper &colptrs, int index);
extern void dJydy_rowvals_Control_rtf(SUNMatrixWrapper &rowvals, int index);
...
extern void dwdp_Control_rtf(realtype *dwdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, const realtype *dtcldp, const realtype *spl, const realtype *sspl);
extern void dwdp_colptrs_Control_rtf(SUNMatrixWrapper &colptrs);
extern void dwdp_rowvals_Control_rtf(SUNMatrixWrapper &rowvals);
...
extern void dydp_Control_rtf(realtype *dydp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const int ip, const realtype *w, const realtype *tcl, const realtype *dtcldp, const realtype *spl, const realtype *sspl);




extern void sigmay_Control_rtf(realtype *sigmay, const realtype t, const realtype *p, const realtype *k, const realtype *y);

extern void dsigmaydp_Control_rtf(realtype *dsigmaydp, const realtype t, const realtype *p, const realtype *k, const realtype *y, const int ip);


extern void w_Control_rtf(realtype *w, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *tcl, const realtype *spl);





extern void y_Control_rtf(realtype *y, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w);
...
extern std::vector<HermiteSpline> create_splines_Control_rtf(const realtype *p, const realtype *k);
 ...
 */
class Model_Control_rtf : public amici::Model_ODE {
  public:
    /**
    ...
    Model_Control_rtf()
        : amici::Model_ODE(
              ...
              amici::SimulationParameters(
                  std::vector<realtype>{0.10000000000000001, -2.0, 5.0}, // fixedParameters
                  std::vector<realtype>{1.0, 1.0, 1.0, 1.0, 3.0, 0.0}        // dynamic parameters
              ),
    ...
    amici::Model *clone() const override {
        return new Model_Control_rtf(*this);
    }
    ...
    void fJy(realtype *Jy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my) override {
        Jy_Control_rtf(Jy, iy, p, k, y, sigmay, my);    
}
    ...
    void fdJydsigma(realtype *dJydsigma, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my) override {
        dJydsigma_Control_rtf(dJydsigma, iy, p, k, y, sigmay, my);    
}
    ...
    void fdsigmaydp(realtype *dsigmaydp, const realtype t, const realtype *p, const realtype *k, const realtype *y, const int ip) override {
        dsigmaydp_Control_rtf(dsigmaydp, t, p, k, y, ip);    
}
    ...
    void fdJydy(realtype *dJydy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my) override {
        dJydy_Control_rtf(dJydy, iy, p, k, y, sigmay, my);    
}

    void fdJydy_colptrs(SUNMatrixWrapper &colptrs, int index) override {        dJydy_colptrs_Control_rtf(colptrs, index);
    }

    void fdJydy_rowvals(SUNMatrixWrapper &rowvals, int index) override {        dJydy_rowvals_Control_rtf(rowvals, index);
    }


    std::vector<HermiteSpline> fcreate_splines(const realtype *p, const realtype *k) override {
        return create_splines_Control_rtf(p, k);    
}
    ...
    void fdwdp(realtype *dwdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, const realtype *dtcldp, const realtype *spl, const realtype *sspl) override {
        dwdp_Control_rtf(dwdp, t, x, p, k, h, w, tcl, dtcldp, spl, sspl);    
}

    void fdwdp_colptrs(SUNMatrixWrapper &colptrs) override {        dwdp_colptrs_Control_rtf(colptrs);
    }

    void fdwdp_rowvals(SUNMatrixWrapper &rowvals) override {        dwdp_rowvals_Control_rtf(rowvals);
    }
    ...
    void fdydp(realtype *dydp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const int ip, const realtype *w, const realtype *tcl, const realtype *dtcldp, const realtype *spl, const realtype *sspl) override {
        dydp_Control_rtf(dydp, t, x, p, k, h, ip, w, tcl, dtcldp, spl, sspl);    
}
    ...
    void fsigmay(realtype *sigmay, const realtype t, const realtype *p, const realtype *k, const realtype *y) override {
        sigmay_Control_rtf(sigmay, t, p, k, y);    
}
    ...
    void fw(realtype *w, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *tcl, const realtype *spl) override {
        w_Control_rtf(w, t, x, p, k, h, tcl, spl);    
}
